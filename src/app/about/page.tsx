        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="prose lg:prose-lg max-w-none text-muted-foreground">
              ...
              <p>
                Founded on the principles of integrity, innovation, and sustainability, Emmydon solar tech enterprises has grown to become a leading provider in the region. We believe in the power of technology to not only power our homes and businesses but also to create a safer, brighter, and cleaner future for generations to come.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
               <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div className="p-8">
                    ...
                    <p className="mt-2 text-muted-foreground">To accelerate the adoption of solar energy and modern security systems by providing high-quality, affordable, and reliable solutions that empower our customers.</p>
                  </div>
                   <div className="p-8">
                    <Eye className="w-12 h-12 mx-auto text-primary"/>
                    <h3 className="text-2xl font-bold mt-4 text-foreground">Our Vision</h3>
                    <p className="mt-2 text-muted-foreground">To be the most trusted and customer-centric technology company, leading the way towards a future where clean energy and security are accessible to everyone.</p>
                  </div>
                   <div className="p-8">
                    <Users className="w-12 h-12 mx-auto text-primary"/>
                    <h3 className="text-2xl font-bold mt-4 text-foreground">Our Team</h3>
                    <p className="mt-2 text-muted-foreground">Our success is driven by our dedicated team of certified engineers, installers, and consultants who share a passion for excellence and sustainability.</p>
                  </div>
               </div>
          </div>
      </section>
